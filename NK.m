...
SPY=0.01*csvread('C:\Company\historical\^GSPC.csv',1,1,[1,1,5001,4]);
 ...
 NNKVOLUM=csvread('C:\Company\historical\^N225.csv',1,5,[1,5,5001,5]);
 NNKVOLUM=0.00000001*flipud(NNKVOLUM);
 
 NNK=0.01*csvread('C:\Company\historical\^N225.csv',1,1,[1,1,5001,4]);
 NNK=flipud(NNK);
