...
GSPC=0.01*csvread('C:\Program Files (x86)\YLoader\data\^GSPC.csv',rows-N-1,3, [rows-N-1,3,rows-1,4]);
...
ALLOVERVOLUM=[GSPC_OPEN,GSPC_HIGH, GSPCVOLUM,VIX];
